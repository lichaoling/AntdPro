!(function(a) {
  if ('object' == typeof exports) module.exports = a();
    ...
    'undefined' != typeof window
      ? (b = window)
      : 'undefined' != typeof global ? (b = global) : 'undefined' != typeof self && (b = self),
      (b.proj4 = a());
  }
})(function() {
  ...
  })(
    {
        ...
        function(a, b, c) {
          b.exports = function(a, b, c, d, e) {
            ...
            for (var h = 0; 15 > h; h++)
              if (
                ((g =
                  (a - (b * f - c * Math.sin(2 * f) + d * Math.sin(4 * f) - e * Math.sin(6 * f))) /
                  (b -
                    2 * c * Math.cos(2 * f) +
                    4 * d * Math.cos(4 * f) -
                    6 * e * Math.cos(6 * f))),
            ...
            for (var e, f, g, h, i = Math.asin(0.5 * b), j = 0; 30 > j; j++)
              if (
                ...
                (e =
                  Math.pow(1 - h * h, 2) /
                  (2 * g) *
                  (b / (1 - a * a) - f / (1 - h * h) + 0.5 / a * Math.log((1 - h) / (1 + h)))),
                (i += e),
                Math.abs(e) <= 1e-10)
              )
                return i;
      ...
      16: [
        function(a, b, c) {
          var d = Math.PI / 2;
          b.exports = function(a, b) {
            for (var c, e, f = 0.5 * a, g = d - 2 * Math.atan(b), h = 0; 15 >= h; h++)
              if (
                ((c = a * Math.sin(g)),
      ...
      20: [
        function(a, b, c) {
          b.exports = function(a, b) {
            ...
            return a > 1e-7
              ? ((c = a * b),
                (1 - a * a) * (b / (1 - c * c) - 0.5 / a * Math.log((1 - c) / (1 + c))))
              : 2 * b;
          };
        },
        {},
      ...
      24: [
        function(a, b, c) {
          ...
          b.exports = function(a, b, c) {
            var e = a * c,
              f = 0.5 * a;
            return (e = Math.pow((1 - e) / (1 + e), f)), Math.tan(0.5 * (d - b)) / e;
          };
        },
        {},
      ],
      25: [
        function(a, b, c) {
          (c.wgs84 = { towgs84: '0,0,0', ellipse: 'WGS84', datumName: 'WGS84' }),
            (c.ch1903 = {
            ...
            (c.s_jtsk = { towgs84: '589,76,480', ellipse: 'bessel', datumName: 'S-JTSK (Ferro)' }),
            (c.beduaram = { towgs84: '-106,-87,188', ellipse: 'clrk80', datumName: 'Beduaram' }),
            (c.gunung_segara = {
              towgs84: '-403,684,41',
              ellipse: 'bessel',
      ...
      26: [
        function(a, b, c) {
          (c.MERIT = { a: 6378137, rf: 298.257, ellipseName: 'MERIT 1983' }),
            (c.SGS85 = { a: 6378136, rf: 298.257, ellipseName: 'Soviet Geodetic System 85' }),
            (c.GRS80 = { a: 6378137, rf: 298.257222101, ellipseName: 'GRS 1980(IUGG, 1980)' }),
            (c.IAU76 = { a: 6378140, rf: 298.257, ellipseName: 'IAU 1976' }),
            (c.airy = { a: 6377563.396, b: 6356256.91, ellipseName: 'Airy 1830' }),
            (c.APL4 = { a: 6378137, rf: 298.25, ellipseName: 'Appl. Physics. 1965' }),
            (c.NWL9D = { a: 6378145, rf: 298.25, ellipseName: 'Naval Weapons Lab., 1965' }),
            (c.mod_airy = { a: 6377340.189, b: 6356034.446, ellipseName: 'Modified Airy' }),
            (c.andrae = { a: 6377104.43, rf: 300, ellipseName: 'Andrae 1876 (Den., Iclnd.)' }),
            (c.aust_SA = {
              a: 6378160,
              rf: 298.25,
              ellipseName: 'Australian Natl & S. Amer. 1969',
            }),
            (c.GRS67 = { a: 6378160, rf: 298.247167427, ellipseName: 'GRS 67(IUGG 1967)' }),
            (c.bessel = { a: 6377397.155, rf: 299.1528128, ellipseName: 'Bessel 1841' }),
            (c.bess_nam = {
              a: 6377483.865,
              rf: 299.1528128,
              ellipseName: 'Bessel 1841 (Namibia)',
            }),
            (c.clrk66 = { a: 6378206.4, b: 6356583.8, ellipseName: 'Clarke 1866' }),
            (c.clrk80 = { a: 6378249.145, rf: 293.4663, ellipseName: 'Clarke 1880 mod.' }),
            (c.clrk58 = {
              a: 6378293.645208759,
              rf: 294.2606763692654,
              ellipseName: 'Clarke 1858',
            }),
            (c.CPM = { a: 6375738.7, rf: 334.29, ellipseName: 'Comm. des Poids et Mesures 1799' }),
            (c.delmbr = { a: 6376428, rf: 311.5, ellipseName: 'Delambre 1810 (Belgium)' }),
            (c.engelis = { a: 6378136.05, rf: 298.2566, ellipseName: 'Engelis 1985' }),
            (c.evrst30 = { a: 6377276.345, rf: 300.8017, ellipseName: 'Everest 1830' }),
            (c.evrst48 = { a: 6377304.063, rf: 300.8017, ellipseName: 'Everest 1948' }),
            (c.evrst56 = { a: 6377301.243, rf: 300.8017, ellipseName: 'Everest 1956' }),
            (c.evrst69 = { a: 6377295.664, rf: 300.8017, ellipseName: 'Everest 1969' }),
            (c.evrstSS = {
              a: 6377298.556,
              rf: 300.8017,
              ellipseName: 'Everest (Sabah & Sarawak)',
            }),
            (c.fschr60 = { a: 6378166, rf: 298.3, ellipseName: 'Fischer (Mercury Datum) 1960' }),
            (c.fschr60m = { a: 6378155, rf: 298.3, ellipseName: 'Fischer 1960' }),
            (c.fschr68 = { a: 6378150, rf: 298.3, ellipseName: 'Fischer 1968' }),
            (c.helmert = { a: 6378200, rf: 298.3, ellipseName: 'Helmert 1906' }),
            (c.hough = { a: 6378270, rf: 297, ellipseName: 'Hough' }),
            (c.intl = { a: 6378388, rf: 297, ellipseName: 'International 1909 (Hayford)' }),
            ...
            (c.new_intl = { a: 6378157.5, b: 6356772.2, ellipseName: 'New International 1967' }),
            (c.plessis = { a: 6376523, rf: 6355863, ellipseName: 'Plessis 1817 (France)' }),
            (c.krass = { a: 6378245, rf: 298.3, ellipseName: 'Krassovsky, 1942' }),
            (c.SEasia = { a: 6378155, b: 6356773.3205, ellipseName: 'Southeast Asia' }),
            (c.walbeck = { a: 6376896, b: 6355834.8467, ellipseName: 'Walbeck' }),
            ...
            (c.WGS84 = { a: 6378137, rf: 298.257223563, ellipseName: 'WGS 84' }),
      ...
      28: [
        function(a, b, c) {
          (c.ft = { to_meter: 0.3048 }), (c['us-ft'] = { to_meter: 1200 / 3937 });
        },
        {},
      ],
      29: [
        function(a, b, c) {
          function d(a, b, c) {
            ...
            return Array.isArray(c)
              ? ((d = g(a, b, c)), 3 === c.length ? [d.x, d.y, d.z] : [d.x, d.y])
              : g(a, b, c);
          }
          function e(a) {
            ...
            m = function(a) {
              return this instanceof m
                ? ((this.datum_type = h),
                  void (
                    a &&
                    (a.datumCode && 'none' === a.datumCode && (this.datum_type = i),
                    a.datum_params &&
          ...
          (m.prototype = {
            ...
            geocentric_to_geodetic_noniter: function(a) {
              var b,
                ...
                x = a.z ? a.z : 0;
              if (
                ((v = parseFloat(v)), (w = parseFloat(w)), (x = parseFloat(x)), (u = !1), 0 !== v)
              )
                b = Math.atan2(w, v);
              else if (w > 0) b = d;
              else if (0 > w) b = -d;
              ...
              return (
                ...
                (e = r >= l ? f / r - s : -l >= r ? f / -r - s : x / q + s * (this.es - 1)),
                u === !1 && (c = Math.atan(q / r)),
                (a.x = b),
                (a.y = c),
                (a.z = e),
        ...
        function(a, b, c) {
          function d(a) {
            ...
            if (2 === arguments.length) {
              var c = arguments[1];
              'string' == typeof c
                ? '+' === c.charAt(0) ? (d[a] = f(arguments[1])) : (d[a] = g(arguments[1]))
                : (d[a] = c);
              ...
              if ('string' == typeof a) {
                ...
                'EPSG' in a
                  ...
                  : 'ESRI' in a
                    ? (d['ESRI:' + a.ESRI] = a)
                    : 'IAU2000' in a ? (d['IAU2000:' + a.IAU2000] = a) : console.log(a);
              return;
            }
          }
          var e = a('./global'),
        ...
        function(a, b, c) {
          ...
          b.exports = function(a) {
            ...
            return (
              ...
              (0 === a.rf || Math.abs(a.a - a.b) < h) && ((a.sphere = !0), (a.b = a.a)),
              (a.a2 = a.a * a.a),
              (a.b2 = a.b * a.b),
              (a.es = (a.a2 - a.b2) / a.a2),
              (a.e = Math.sqrt(a.es)),
      ...
      38: [
        function(a, b, c) {
          ...
          b.exports = function(a) {
            ...
            for (g in c)
              (h = c[g]),
                g in j ? ((i = j[g]), 'function' == typeof i ? i(h) : (b[i] = h)) : (b[g] = h);
            return (
            ...
            (c.inverse = function(a) {
              ...
              return (
                ...
                this.sphere
                  ...
                  : ((c = (this.c - d * d) / this.ns0), (h = this.phi1z(this.e3, c))),
              ...
              for (var k = a * a, l = 1; 25 >= l; l++)
                if (
                  ...
                  (i =
                    ...
                    g /
                    e *
                    (b / (1 - k) - c / g + 0.5 / a * Math.log((1 - f) / (1 + f)))),
                  (j += i),
                  Math.abs(i) <= 1e-7)
                )
                  return j;
                ...
                ? Math.abs(this.sin_p12 - 1) <= f
                  ...
                  : Math.abs(this.sin_p12 + 1) <= f
                    ...
                    : ((B = this.sin_p12 * J + this.cos_p12 * K * Math.cos(L)),
                      ...
                      (a.y =
                        this.y0 + this.a * A * (this.cos_p12 * J - this.sin_p12 * K * Math.cos(L))),
                      a)
                : ((b = h(this.es)),
                  (c = i(this.es)),
                  (m = j(this.es)),
                  ...
                  Math.abs(this.sin_p12 - 1) <= f
                    ...
                    : Math.abs(this.sin_p12 + 1) <= f
                      ...
                      : ((q = J / K),
                        ...
                        (C =
                          0 === u
                            ? Math.asin(this.cos_p12 * Math.sin(t) - this.sin_p12 * Math.cos(t))
                            : Math.abs(Math.abs(u) - Math.PI) <= f
                              ? -Math.asin(this.cos_p12 * Math.sin(t) - this.sin_p12 * Math.cos(t))
                              : Math.asin(Math.sin(L) * Math.cos(t) / Math.sin(u))),
                      ...
                      (q = d(
                        Math.abs(s) <= f
                          ? this.lat0 >= 0
                            ...
                            : this.long0 - Math.atan2(-a.x, a.y)
                          : this.long0 +
                            Math.atan2(a.x * o, b * this.cos_p12 * p - a.y * this.sin_p12 * o)
                      ))),
                  (a.x = q),
                  (a.y = r),
                  a
                ...
                Math.abs(this.sin_p12 - 1) <= f
                  ...
                  : Math.abs(this.sin_p12 + 1) <= f
                    ...
                    : ((b = Math.sqrt(a.x * a.x + a.y * a.y)),
                      ...
                      (r = Math.atan(
                        (1 - this.es * I * this.sin_p12 / Math.sin(A)) * Math.tan(A) / (1 - this.es)
                      )),
                      (a.x = q),
                      (a.y = r),
                      a)
            ...
            (c.forward = function(a) {
              ...
              if (((e = j(e - this.long0)), this.sphere))
                ...
                (b = k * m * (1 - n * l * (1 / 6 - (8 - l + 8 * o) * n / 120))),
                  (c = p - this.ml0 + k * g / h * n * (0.5 + (5 - l + 6 * o) * n / 24));
              }
            ...
            (c.inverse = function(a) {
              ...
              if (this.sphere) {
                ...
                var o = i(this.a, this.e, Math.sin(h)),
                  ...
                  r = d * this.a / o,
                  s = r * r;
                (b = h - o * Math.tan(h) / p * r * r * (0.5 - (1 + 3 * q) * r * r / 24)),
          ...
          (c.init = function() {
            ...
            (c.forward = function(a) {
              ...
              if (this.sphere)
                ...
                (b = this.x0 + this.a * this.k0 * h), (c = this.y0 + this.a * i * 0.5 / this.k0);
              }
          ...
          (c.init = function() {
            ...
            (b *= b),
              ...
              (this.K =
                ...
                (Math.pow(Math.tan(0.5 * this.lat0 + d), this.C) * e(this.e * a, this.ratexp)));
          }),
            (c.forward = function(a) {
              var b = a.x,
                c = a.y;
            ...
            (c.inverse = function(a) {
              for (
                var b = 1e-14,
                  ...
                  j = g;
                j > 0 &&
                ((h = 2 * Math.atan(i * e(this.e * Math.sin(a.y), -0.5 * this.e)) - f),
                !(Math.abs(h - a.y) < b));
                --j
              )
                a.y = h;
              ...
              return (
                ...
                i > 0 || Math.abs(i) <= e
                  ? ((j = this.x0 + this.a * h * c * Math.sin(f) / i),
                    (k = this.y0 + this.a * h * (this.cos_p14 * b - this.sin_p14 * c * g) / i))
          ...
          (c.init = function() {
            ...
            (c.forward = function(a) {
              ...
              return (
                ...
                (c =
                  2 *
                  (Math.atan(this.k * Math.pow(Math.tan(k / 2 + this.s45), this.alfa) / b) -
                    this.s45)),
                (e = -l * this.alfa),
                (f = Math.asin(
                  Math.cos(this.ad) * Math.sin(c) + Math.sin(this.ad) * Math.cos(c) * Math.cos(e)
                )),
            ...
            (c.inverse = function(a) {
              ...
              (a.x = a.y),
                ...
                (d =
                  2 *
                  (Math.atan(
                    Math.pow(this.ro0 / g, 1 / this.n) * Math.tan(this.s0 / 2 + this.s45)
                  ) -
                    this.s45)),
                (b = Math.asin(
                  Math.cos(this.ad) * Math.sin(d) - Math.sin(this.ad) * Math.cos(d) * Math.cos(e)
                )),
                ...
                (a.y =
                  ...
                  (Math.atan(
                    Math.pow(this.k, -1 / this.alfa) *
                      ...
                      Math.pow((1 + this.e * Math.sin(h)) / (1 - this.e * Math.sin(h)), this.e / 2)
                  ) -
                    this.s45)),
            ...
            (c.init = function() {
              ...
              if (
                (Math.abs(a - d) < f
                  ...
                  : Math.abs(a) < f ? (this.mode = this.EQUIT) : (this.mode = this.OBLIQ),
                this.es > 0)
              ) {
                var b;
                ...
                this.mode)) {
                  ...
                  case this.OBLIQ:
                    (this.rq = Math.sqrt(0.5 * this.qp)),
                      ...
                      (this.dd =
                        Math.cos(this.lat0) /
                        (Math.sqrt(1 - this.es * b * b) * this.rq * this.cosb1)),
            ...
            (c.forward = function(a) {
              ...
              if (((q = h(q - this.long0)), this.sphere)) {
                if (
                  ...
                  if ((this.mode === this.N_POLE && (i = -i), Math.abs(r + this.phi0) < f))
                    return null;
                  (c = e - 0.5 * r),
            ...
            (c.inverse = function(a) {
              ...
              if (this.sphere) {
                var n,
                  o = 0,
                  p = 0;
                if (((n = Math.sqrt(l * l + m * m)), (c = 0.5 * n), c > 1)) return null;
                ...
                this.mode)) {
                  ...
                  case this.OBLIQ:
                    (c =
                      Math.abs(n) <= f
                        ? this.phi0
                        : Math.asin(o * this.sinph0 + m * p * this.cosph0 / n)),
                      (l *= p * this.cosph0),
                ...
                b =
                  0 !== m || (this.mode !== this.EQUIT && this.mode !== this.OBLIQ)
                    ? Math.atan2(l, m)
                    : 0;
              } else {
                if (((k = 0), this.mode === this.OBLIQ || this.mode === this.EQUIT)) {
                  if (((l /= this.dd), (m *= this.dd), (j = Math.sqrt(l * l + m * m)), f > j))
                  ...
                  if ((this.mode === this.N_POLE && (m = -m), (i = l * l + m * m), !i))
                    return (a.x = 0), (a.y = this.phi0), a;
        ...
        function(a, b, c) {
          ...
          (c.init = function() {
            ...
            (c.forward = function(a) {
              ...
              if (k > d)
                (e = f(this.e, c, Math.sin(c))), (j = this.a * this.f0 * Math.pow(e, this.ns));
              else {
            ...
            (this.es = 1 - a * a),
              ...
              this.lat_ts
                ? this.sphere
                  ...
                  : (this.k0 = d(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)))
            ...
            (c.forward = function(a) {
              ...
              if (this.sphere)
                (d = this.x0 + this.a * this.k0 * h(b - this.long0)),
                  (k = this.y0 + this.a * this.k0 * Math.log(Math.tan(i + 0.5 * c)));
              else {
                var l = Math.sin(c),
                  m = j(this.e, c, l);
                (d = this.x0 + this.a * this.k0 * h(b - this.long0)),
          ...
          (c.init = function() {}),
            ...
            (c.inverse = function(a) {
              ...
              (a.x -= this.x0),
                ...
                (b = Math.asin(c));
              var e = d(this.long0 + a.x / (0.900316316158 * this.a * Math.cos(b)));
              e < -Math.PI && (e = -Math.PI),
                e > Math.PI && (e = Math.PI),
        ...
        function(a, b, c) {
          ...
          (c.init = function() {
            ...
            this.no_off
              ...
              : this.lat0 >= 0
                ? (this.uc =
                    this.al / this.bl * Math.atan2(Math.sqrt(g * g - 1), Math.cos(this.alpha)))
                : (this.uc =
                    -1 *
                    this.al /
                    this.bl *
            ...
            (c.forward = function(a) {
              ...
              if (Math.abs(Math.abs(k) - g) <= i)
                (f = k > 0 ? -1 : 1),
                  (c = this.al / this.bl * Math.log(Math.tan(h + f * this.gamma0 * 0.5))),
                ...
                (c =
                  ...
                  (b =
                    Math.abs(Math.cos(this.bl * l)) <= i
                      ...
                      : this.al *
                        Math.atan2(
                          o * Math.cos(this.gamma0) + q * Math.sin(this.gamma0),
                          Math.cos(this.bl * l)
                        ) /
                        this.bl);
              }
              ...
              if (((d = a.x - this.x0), (e = a.y - this.y0), this.sphere))
                if (Math.abs(e + this.a * this.lat0) <= k)
                  ...
                  for (f = m; f; --f)
                    if (
                      ((o = Math.tan(l)),
                      (n = -1 * (g * (l * o + 1) - l - 0.5 * (l * l + i) * o) / ((l - g) / o - 1)),
                      (l += n),
                      Math.abs(n) <= k)
                    ) {
                      c = l;
                ...
                for (f = m; f; --f)
                  if (
                    ...
                    (n =
                      ...
                      (this.es * Math.sin(2 * l) * (s * s + i - 2 * g * s) / (4 * p) +
                  ...
                  : ((b = i(a.y / this.a, this.es, this.en)),
                    ...
                    j > g
                      ? ((g = Math.sin(b)),
                        (c =
                          this.long0 +
                          a.x * Math.sqrt(1 - this.es * g * g) / (this.a * Math.cos(b))),
                        (f = d(c)))
                      : j > g - k && (f = this.long0)),
                (a.x = f),
                (a.y = b),
            ...
            (c.forward = function(a) {
              var b = Math.log(Math.tan(Math.PI / 4 - a.y / 2)),
                c =
                  this.e /
                  2 *
                  Math.log((1 + this.e * Math.sin(a.y)) / (1 - this.e * Math.sin(a.y))),
                d = -this.alpha * (b + c) + this.K,
                e = 2 * (Math.atan(Math.exp(d)) - Math.PI / 4),
                f = this.alpha * (a.x - this.lambda0),
                g = Math.atan(
                  Math.sin(f) / (Math.sin(this.b0) * Math.tan(e) + Math.cos(this.b0) * Math.cos(f))
                ),
                h = Math.asin(
                  Math.cos(this.b0) * Math.sin(e) - Math.sin(this.b0) * Math.cos(e) * Math.cos(f)
                );
              return (
                (a.y = this.R / 2 * Math.log((1 + Math.sin(h)) / (1 - Math.sin(h))) + this.y0),
            ...
            (c.inverse = function(a) {
              for (
                var b = a.x - this.x0,
                  ...
                  f = Math.asin(
                    Math.cos(this.b0) * Math.sin(e) + Math.sin(this.b0) * Math.cos(e) * Math.cos(d)
                  ),
                  g = Math.atan(
                    Math.sin(d) /
                      (Math.cos(this.b0) * Math.cos(d) - Math.sin(this.b0) * Math.tan(e))
                  ),
                ...
                if (++l > 20) return;
                (i =
                  1 / this.alpha * (Math.log(Math.tan(Math.PI / 4 + f / 2)) - this.K) +
                  this.e * Math.log(Math.tan(Math.PI / 4 + Math.asin(this.e * Math.sin(j)) / 2))),
                  (k = j),
      ...
      60: [
        function(a, b, c) {
          ...
          (c.ssfn_ = function(a, b, c) {
            return (b *= c), Math.tan(0.5 * (d + a)) * Math.pow((1 - b) / (1 + b), 0.5 * c);
          }),
            (c.init = function() {
                  ...
                  : (Math.abs(this.coslat0) <= e &&
                    ...
                    1 === this.k0 &&
                      ...
                      (this.k0 =
                        0.5 *
                        this.cons *
                        g(this.e, Math.sin(this.lat_ts), Math.cos(this.lat_ts)) /
                        h(this.e, this.con * this.lat_ts, this.con * Math.sin(this.lat_ts))),
            ...
            (c.forward = function(a) {
              ...
              return Math.abs(Math.abs(l - this.long0) - Math.PI) <= e &&
                ...
                ? ((a.x = NaN), (a.y = NaN), a)
                : this.sphere
                  ? ((b = 2 * this.k0 / (1 + this.sinlat0 * n + this.coslat0 * o * Math.cos(p))),
                    (a.x = this.a * b * o * Math.sin(p) + this.x0),
                    (a.y =
                      this.a * b * (this.coslat0 * n - this.sinlat0 * o * Math.cos(p)) + this.y0),
                    a)
                  : ((c = 2 * Math.atan(this.ssfn_(m, n, this.e)) - d),
                    ...
                    Math.abs(this.coslat0) <= e
                      ...
                      : (Math.abs(this.sinlat0) < e
                          ? ((b = 2 * this.a * this.k0 / (1 + g * Math.cos(p))), (a.y = b * f))
                          : ((b =
                              2 *
                              this.a *
                              this.k0 *
                              this.ms1 /
                              (this.cosX0 * (1 + this.sinX0 * f + this.cosX0 * g * Math.cos(p)))),
              ...
              if (this.sphere) {
                ...
                return (
                  ...
                  e >= k
                    ? ((a.x = b), (a.y = c), a)
                    : ((c = Math.asin(
                        Math.cos(l) * this.sinlat0 + a.y * Math.sin(l) * this.coslat0 / k
                      )),
                      (b = j(
                        Math.abs(this.coslat0) < e
                          ? this.lat0 > 0
                          ...
                          : this.long0 +
                            Math.atan2(
                              a.x * Math.sin(l),
                              k * this.coslat0 * Math.cos(l) - a.y * this.sinlat0 * Math.sin(l)
                            )
                      )),
                      (a.x = b),
                      (a.y = c),
              ...
              if (Math.abs(this.coslat0) <= e) {
                ...
                (g = 2 * Math.atan(k * this.cosX0 / (2 * this.a * this.k0 * this.ms1))),
                  ...
                  e >= k
                    ? (h = this.X0)
                    : ((h = Math.asin(
                        Math.cos(g) * this.sinX0 + a.y * Math.sin(g) * this.cosX0 / k
                      )),
                      (b = j(
                        this.long0 +
                          Math.atan2(
                            a.x * Math.sin(g),
                            k * this.cosX0 * Math.cos(g) - a.y * this.sinX0 * Math.sin(g)
                          )
                      ))),
        ...
        function(a, b, c) {
          ...
          (c.init = function() {
            ...
            (c.inverse = function(a) {
              ...
              return (
                (a.x = f), (a.y = g), d.inverse.apply(this, [a]), (a.x = e(a.x + this.long0)), a
              );
            }),
            (c.names = [
                    ...
                    (1 +
                      n /
                        ...
                        (1 -
                          q +
                          o +
                          n / 20 * (5 - 18 * q + Math.pow(q, 2) + 72 * o - 58 * this.ep2))) +
                  this.x0),
                  (d =
                    this.k0 *
                      (s -
                            ...
                            (0.5 +
                              n /
                                ...
                                (5 -
                                  ...
                                  n /
                                    30 *
                                    (61 - 58 * q + Math.pow(q, 2) + 600 * o - 330 * this.ep2))))) +
                    this.y0);
              }
                      ...
                      (0.5 -
                        D /
                          ...
                          (5 +
                            ...
                            4 * x -
                            9 * this.ep2 -
                            D / 30 * (61 + 90 * y + 298 * w + 45 * z - 252 * this.ep2 - 3 * x)))),
                    (g = i(
                      this.long0 +
                        C *
                          (1 -
                            D /
                              ...
                              (1 +
                                2 * y +
                                w -
                                D / 20 * (5 - 2 * w + 28 * y - 3 * x + 8 * this.ep2 + 24 * z))) /
                          u
                    ));
            ...
            (c.forward = function(a) {
              ...
              var l = 0.5 * Math.abs(Math.PI / j - j / Math.PI),
                ...
                t =
                  Math.PI *
                  this.R *
                  (l * (p - s) + Math.sqrt(m * (p - s) * (p - s) - (s + m) * (q - s))) /
                  (s + m);
              0 > j && (t = -t), (b = this.x0 + t);
              var u = m + p;
              return (
                (t =
                  Math.PI * this.R * (r * u - l * Math.sqrt((s + m) * (m + 1) - u * u)) / (s + m)),
              ...
              return (
                ...
                (b =
                  Math.abs(e) < f
                    ...
                    : d(
                        this.long0 +
                          Math.PI * (h - 1 + Math.sqrt(1 + 2 * (e * e - g * g) + h * h)) / 2 / e
                      )),
                (a.x = b),
                (a.y = c),
                a
      ...
      65: [
        function(a, b, c) {
          ...
          b.exports = function l(a, b, c) {
            function m(a, b) {
              return (
                (a.datum.datum_type === f || a.datum.datum_type === g) && 'WGS84' !== b.datumCode
              );
            }
            var n;
            return (
              ...
              'longlat' === a.projName
                ? ((c.x *= d), (c.y *= d))
                : (a.to_meter && ((c.x *= a.to_meter), (c.y *= a.to_meter)), a.inverse(c)),
              a.from_greenwich && (c.x += a.from_greenwich),
              (c = h(a.datum, b.datum, c)),
              b.from_greenwich && (c.x -= b.from_greenwich),
              'longlat' === b.projName
                ? ((c.x *= e), (c.y *= e))
                : (b.forward(c), b.to_meter && ((c.x /= b.to_meter), (c.y /= b.to_meter))),
              'enu' !== b.axis && i(b, !0, c),
              c
            );
          };
          ...
          function e(a, b) {
            ...
            return Array.isArray(a)
              ? ((c = a.shift()),
                ...
                1 === a.length
                  ? Array.isArray(a[0]) ? ((b[c] = {}), e(a[0], b[c])) : (b[c] = a[0])
                  : a.length
                    ? 'TOWGS84' === c
                      ? (b[c] = a)
                      : ((b[c] = {}),
            ...
            'GEOGCS' === a.type
              ...
              a.UNIT &&
                ...
                a.UNIT.convert &&
                  ('GEOGCS' === a.type
                    ? a.DATUM &&
                      a.DATUM.SPHEROID &&
                      (a.to_meter = parseFloat(a.UNIT.convert, 10) * a.DATUM.SPHEROID.a)
              ...
              a.GEOGCS &&
                ...
                'wgs_1984' === a.datumCode &&
                  ('Mercator_Auxiliary_Sphere' === a.PROJECTION && (a.sphere = !0),
                  (a.datumCode = 'wgs84')),
        ...
        function(a, b, c) {
          ...
          function f(a) {
            ...
            (l = Math.floor((n + 180) / 6) + 1),
              ...
              (j =
                ...
                ((1 - p / 4 - 3 * p * p / 64 - 5 * p * p * p / 256) * r -
                  (3 * p / 8 + 3 * p * p / 32 + 45 * p * p * p / 1024) * Math.sin(2 * r) +
                  (15 * p * p / 256 + 45 * p * p * p / 1024) * Math.sin(4 * r) -
            ...
            var t =
                q *
                  ...
                  (i +
                    (1 - f + g) * i * i * i / 6 +
                    (5 - 18 * f + f * f + 72 * g - 58 * c) * i * i * i * i * i / 120) +
                5e5,
              u =
                q *
                (j +
                  e *
                    ...
                    (i * i / 2 +
                      ...
                      (61 - 58 * f + f * f + 600 * g - 330 * c) * i * i * i * i * i * i / 720));
            return (
              0 > m && (u += 1e7),
              { northing: Math.round(u), easting: Math.round(t), zoneNumber: l, zoneLetter: h(m) }
            );
          }
          function g(a) {
            var b = a.northing,
            ...
            'N' > d && (w -= 1e7),
              ...
              (q =
                ...
                (21 * u * u / 16 - 55 * u * u * u * u / 32) * Math.sin(4 * p) +
            ...
            var x =
              ...
              i *
                ...
                l *
                (m * m / 2 -
                  (5 + 3 * j + 10 * k - 4 * k * k - 9 * h) * m * m * m * m / 24 +
            ...
            var y =
              (m -
                (1 + 2 * j + k) * m * m * m / 6 +
                (5 - 2 * k + 28 * j - 3 * k * k + 8 * h + 24 * j * j) * m * m * m * m * m / 120) /
              Math.cos(q);
            y = o + e(y);
            var z;
            if (a.accuracy) {
          ...
          function l(a, b, c) {
            ...
            g > x && ((g = g - x + t - 1), (i = !0)),
              ...
              (g === v || (v > e && g > v) || ((g > v || v > e) && i)) && (g++, g === u && g++),
              g > x && (g = g - x + t - 1),
              h > w ? ((h = h - w + t - 1), (i = !0)) : (i = !1),
              (h === u || (u > f && h > u) || ((h > u || u > f) && i)) && h++,
              (h === v || (v > f && h > v) || ((h > v || v > f) && i)) && (h++, h === u && h++),
              h > w && (h = h - w + t - 1);
          ...
          function m(a) {
            ...
            return (
              ...
              (t = w + j),
              (u = x + l),
              { easting: t, northing: u, zoneLetter: h, zoneNumber: g, accuracy: q }
            );
          }
          function n(a, b) {
