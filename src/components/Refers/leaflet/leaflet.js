...
!(function(t, i) {
  ...
  function w(t, i, e) {
    return t instanceof x
      ...
      : ei(t)
        ...
        : void 0 === t || null === t
          ? t
          : 'object' == typeof t && 'x' in t && 'y' in t ? new x(t.x, t.y) : new x(t, i, e);
  }
  function P(t, i) {
  ...
  function C(t, i, e) {
    return t instanceof M
      ...
      : ei(t) && 'object' != typeof t[0]
        ? 3 === t.length ? new M(t[0], t[1], t[2]) : 2 === t.length ? new M(t[0], t[1]) : null
        : void 0 === t || null === t
          ? t
          : 'object' == typeof t && 'lat' in t
            ? new M(t.lat, 'lng' in t ? t.lng : t.lon, t.alt)
            : void 0 === i ? null : new M(t, i, e);
  }
  function Z(t, i, e, n) {
  ...
  function I(t, i, e, n) {
    return (
      'touchstart' === i
        ? O(t, e, n)
        : 'touchmove' === i ? W(t, e, n) : 'touchend' === i && H(t, e, n),
      this
    );
  }
  function B(t, i, e) {
  ...
  function Y(t) {
    return (
      t.stopPropagation
        ? t.stopPropagation()
        : t.originalEvent ? (t.originalEvent._stopped = !0) : (t.cancelBubble = !0),
      nt(t),
      this
    );
  }
    ...
    for (r = 0; r < 4; r++) {
      for (l = _[r], n = [], o = 0, s = (u = t.length) - 1; o < u; s = o++)
        (a = t[o]),
          (h = t[s]),
          a._code & l
            ? h._code & l || (((c = It(h, a, l, i, e))._code = Bt(c, i)), n.push(c))
            : (h._code & l && (((c = It(h, a, l, i, e))._code = Bt(c, i)), n.push(c)), n.push(a));
      t = n;
    }
    return t;
  }
    ...
    Le = ui.extend({
      ...
      initialize: function(t, i) {
        (i = l(this, i)),
          ...
          this._zoomAnimated &&
            (this._createAnimProxy(), V(this._proxy, fe, this._catchTransitionEnd, this)),
  ...
  var sn = Kt,
    rn = Ue.extend({
      ...
      onAdd: function() {
        this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
          this.options.interactive &&
            (pt(this._image, 'leaflet-interactive'), this.addInteractiveTarget(this._image)),
    ...
    hn = Ue.extend({
      ...
      setLatLng: function(t) {
        return (
          (this._latlng = C(t)), this._map && (this._updatePosition(), this._adjustPan()), this
        );
      },
      getContent: function() {
  ...
  var _n = Ue.extend({
      ...
      _clampZoom: function(t) {
        ...
        return void 0 !== i.minNativeZoom && t < i.minNativeZoom
          ? i.minNativeZoom
          : void 0 !== i.maxNativeZoom && i.maxNativeZoom < t ? i.maxNativeZoom : t;
      },
      ...
      _tileReady: function(t, i, n) {
        if (this._map) {
          ...
          (n = this._tiles[o]) &&
            ...
            i ||
              (pt(n.el, 'leaflet-tile-loaded'), this.fire('tileload', { tile: n.el, coords: t })),
            this._noTilesToLoad() &&
              ((this._loading = !1),
              this.fire('load'),
