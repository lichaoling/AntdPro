...
!(function(t, e, i) {
  ...
  (L.drawVersion = '0.4.14'),
        ...
        return t || this.options.showLength
          ? (this.options.showLength &&
            ...
            t &&
              (e +=
                '<br>' +
                L.GeometryUtil.readableArea(t, this.options.metric, this.options.precision)),
            e)
          : null;
      },
      _shapeIsValid: function() {
        ...
        if ((this._tooltip.updatePosition(i), this._isDrawing)) {
          ...
          o &&
            (a =
              ...
              ': ' +
              L.GeometryUtil.readableDistance(e, n, this.options.feet, this.options.nautic)),
    ...
    L.Marker.addInitHook(function() {
      L.Edit.Marker &&
        ((this.editing = new L.Edit.Marker(this)), this.options.editable && this.editing.enable());
    }),
    (L.Edit = L.Edit || {}),
    ...
    (L.Edit.PolyVerticesEdit = L.Handler.extend({
      ...
      _defaultShape: function() {
        return L.Polyline._flat
          ? L.Polyline._flat(this._latlngs) ? this._latlngs : this._latlngs[0]
          : this._latlngs;
      },
      addHooks: function() {
        var t = this._poly,
      ...
      L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
        geodesicArea: function(t) {
          ...
          if (o > 2) {
            for (var s = 0; s < o; s++)
              (e = t[s]),
                (i = t[(s + 1) % o]),
                (n += (i.lng - e.lng) * a * (2 + Math.sin(e.lat * a) + Math.sin(i.lat * a)));
        ...
        readableDistance: function(e, i, o, n, a) {
          var s,
            a = L.Util.extend({}, t, a);
          switch (i
            ? 'string' == typeof i ? i : 'metric'
            : o ? 'feet' : n ? 'nauticalMile' : 'yards') {
            case 'metric':
              s =
                e > 1e3
    ...
    (L.Draw.Tooltip = L.Class.extend({
      ...
      updatePosition: function(t) {
        ...
        return (
          this._container &&
            (this._visible && (i.style.visibility = 'inherit'), L.DomUtil.setPosition(i, e)),
          this
        );
      },
