...
class MyNewLayout2 extends React.PureComponent {
  constructor(ps) {
    super(ps);
    this.state = {
      nav: 'nav1',
    ...
    const SiderMenu2 = (
      ...
      >
        <SubMenu
          ...
          title={
            <span>
              <Icon type="user" />nav2_subnav1
            </span>
          }
        >
          <Menu.Item key="7">
            <Link to="/mynew2/nav2/subnav1/option1">option1</Link>
          </Menu.Item>
          <Menu.Item key="8">
            <Link to="/mynew2/nav2/subnav1/option2">option2</Link>
          </Menu.Item>
        </SubMenu>
        <SubMenu
          key="nav2_subnav2"
          title={
            <span>
              <Icon type="laptop" />nav2_subnav2
            </span>
          }
        >
          <Menu.Item key="9">
            <Link to="/mynew2/nav2/subnav2/option3">option3</Link>
          </Menu.Item>
          <Menu.Item key="10">
            <Link to="/mynew2/nav2/subnav2/option4">option4</Link>
          </Menu.Item>
        </SubMenu>
        <SubMenu
          key="nav2_subnav3"
          title={
            <span>
              <Icon type="notification" />nav2_subnav3
            </span>
          }
        >
          <Menu.Item key="11">
            <Link to="/mynew2/nav2/subnav3/option5">option5</Link>
          </Menu.Item>
          <Menu.Item key="12">
            <Link to="/mynew2/nav2/subnav3/option6">option6</Link>
          </Menu.Item>
        </SubMenu>
      </Menu>
    );
    // const SiderMenu3 = <Menu
    //     mode="inline"
    //     defaultSelectedKeys={['13']}
    //     defaultOpenKeys={['nav3_subnav1s']}
    //     style={{ height: '100%', borderRight: 0 }}
    // >
    //     <SubMenu key="nav3_subnav1" title={<span><Icon type="user" />nav3_subnav1</span>}>
    //         <Menu.Item key="13"><Link to="/mynew/nav3/subnav1/option1">option1</Link></Menu.Item>
    //         <Menu.Item key="14"><Link to="/mynew/nav3/subnav1/option2">option2</Link></Menu.Item>
    //     </SubMenu>
    //     <SubMenu key="nav3_subnav2" title={<span><Icon type="laptop" />nav3_subnav2</span>}>
    //         <Menu.Item key="15"><Link to="/mynew/nav3/subnav2/option3">option3</Link></Menu.Item>
    //         <Menu.Item key="16"><Link to="/mynew/nav3/subnav2/option4">option4</Link></Menu.Item>
    //     </SubMenu>
    //     <SubMenu key="nav3_subnav3" title={<span><Icon type="notification" />nav3_subnav3</span>}>
    //         <Menu.Item key="17"><Link to="/mynew/nav3/subnav3/option5">option5</Link></Menu.Item>
    //         <Menu.Item key="18"><Link to="/mynew/nav3/subnav3/option6">option6</Link></Menu.Item>
    //     </SubMenu>
    // </Menu>;
